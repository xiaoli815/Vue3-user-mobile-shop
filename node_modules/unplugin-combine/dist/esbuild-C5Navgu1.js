	...
	return (userOptions) => {
		...
		return (compiler) => {
			if (plugins instanceof Promise) {
				...
				*/
				if (framework === "rspack") compiler.hooks.watchRun.tapPromise(name, async () => {
					executePlugins(compiler, framework, await plugins);
				});
...
//#endregion
export { getVitePlugin as a, getRollupPlugin as c, resolvePlugins as i, getRolldownPlugin as l, createCombinePlugin as n, getRspackPlugin as o, getPluginList as r, getWebpackPlugin as s, getEsbuildPlugin as t };
